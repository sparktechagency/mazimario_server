  ...
  <html>
    ...
    <body>
      <div class="container">
        ...
        <p>Hello${data.user ? ', ' + data.user : ''}</p>
        <p>Your OTP verification code for Dodawork is:</p>
        <div class="code">${data.activationCode}</div>
        <p>Please enter this code within the next <strong>${data.activationCodeExpire} minutes</strong> to continue.</p>
